...
(function (root, factory) {
    ...
    */
        ...
        var wasmMemory;
        var wasmTable = new WebAssembly.Table({ initial: 10, maximum: 10, element: 'anyfunc' });
        var ABORT = false;
        var EXITSTATUS = 0;
        ...
        var DYNAMIC_BASE = 5254064,
            DYNAMICTOP_PTR = 10992;
        var INITIAL_TOTAL_MEMORY = Module['TOTAL_MEMORY'] || 104857600;
        ...
        var asmLibraryArg = {
            ...
            __memory_base: 1024,
            __table_base: 0,
            f: _broadwayOnHeadersDecoded,
            e: _broadwayOnPictureDecoded,
