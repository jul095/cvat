                    ...
                    if (i > 0) {
                        ...
                        if (sample >= previousSampleCount) {
                            ...
                            if (i == table.length - 1) {
                                return {
                                    index:
                                        totalChunkCount + previousChunkCount + Math.floor(sample / row.samplesPerChunk),
                                    offset: sample % row.samplesPerChunk,
                                };
                            }
                        } else {
    ...
    var Broadway = (function broadway() {
        function constructor(div) {
            ...
            controls.setAttribute(
                'style',
                'z-index: 100; position: absolute; bottom: 0px; background-color: rgba(0,0,0,0.8); height: 30px; width: 100%; text-align: left;',
            );
